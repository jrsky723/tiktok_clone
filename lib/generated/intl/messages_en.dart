...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m1(value, value2) =>
      "${value} ${Intl.plural(value2, zero: 'comments', one: 'commment', other: 'comments')}";

  static String m2(value) => "${value}";

  static String m3(nameOfTheApp) => "Log into ${nameOfTheApp} account";
  ...
  static String m5(nameOfTheApp, when) => "Sign Up for ${nameOfTheApp}";
