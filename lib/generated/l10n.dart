...
class S {
  ...
  /// `{value} {value2, plural, =0{comments} =1{commment} other{comments}}`
  String commentTitle(int value, num value2) {
    ...
    return Intl.message(
      '$valueString ${Intl.plural(value2, zero: 'comments', one: 'commment', other: 'comments')}',
      name: 'commentTitle',
      desc: 'Anything you want',
